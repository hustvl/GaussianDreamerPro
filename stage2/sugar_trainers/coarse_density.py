...
def coarse_training_with_density_regularization(args):
    ...
    # ====================SDS function====================
    parser_lucid = ArgumentParser(description="Training script parameters")

    parser_lucid.add_argument('--opt', type=str, default='./lucidconfigs/temp.yaml')
    ...
    save_folder = os.path.join(lp._model_path,"train_process/")
    ...
    for batch in range(9_999_999):
        ...
        loss = loss + opt.lambda_tv * loss_tv + opt.lambda_scale *  + opt.lambda_bin * loss_bin#opt.lambda_tv * loss_tv + opt.lambda_bin * loss_bin + opt.lambda_scale * loss_scale +
