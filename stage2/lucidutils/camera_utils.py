...
from lucidscene.cameras import Camera, RCamera, SCamera
import numpy as np
from lucidutils.general_utils import PILtoTorch
from lucidutils.graphics_utils import fov2focal
...
def loadRandomCam(opt, id, cam_info, resolution_scale, SSAA=False):
    return SCamera(colmap_id=cam_info.uid, R=cam_info.R, T=cam_info.T, image_w=cam_info.width, image_h=cam_info.height,
